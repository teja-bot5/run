import { updateGround, setupGround, setGroundLose } from "./ground.js"
import { updateclouds, setupclouds, setCloudsLose } from "./clouds.js"
...
const MAX_SPEED_SCALE = 5      // 🔥 hard cap (no madness)
...
const hitSoundElem = document.querySelector("[data-hit-sound]")
...
function handleLose() {
  ...
  if (hitSoundElem) {
    hitSoundElem.currentTime = 0
    hitSoundElem.play().catch(() => {})
  }
